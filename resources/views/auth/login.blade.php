...
@section('content')
<div class="auth-wrapper auth-v1 px-2  justify-content-center ">
  <div class="auth-inner py-2">
    <!-- Login v1 -->
    <div class="card mb-0 mt-5 text-center">
      <div class="card-body ">
        <a href="javascript:void(0);" class="brand-logo">
          ...
          <h2 class="brand-text text-primary ml-1">Hello Sticker Market</h2>
        </a>

        <h4 class="card-title mb-1">Welcome to Sticker Market! 👋</h4>
        <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

        <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
          @csrf
          <div class="form-group text-star">
          ...
          <button type="submit" class="btn btn-primary btn-block mt-2" tabindex="4">Sign in</button>
        </form>
